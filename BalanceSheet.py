...
##
path = "C:/Users/H3/Desktop/github/mycodel"
error = []
...
def first_type(link):
    ...
    st_df.to_excel(f'C:/Users/H3/Desktop/balance/test/{name+period+date}.xlsx')
...
def sec_type(link):
    ...
    dfbase.to_excel(f'C:/Users/H3/Desktop/balance/test2/{name+period+date}.xlsx')
